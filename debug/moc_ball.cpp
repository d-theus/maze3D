...
**
** Created: Sat 10. Dec 23:31:36 2011
...
static const char qt_meta_stringdata_Ball[] = {
    ...
    "calcAcceleration(double,double)\0"
    "calcPosition()\0calcVelocity()\0draw()\0"
    "updateCalculations()\0normal\0"
    "collisionFrom(QVector3D)\0endCollision()\0"
};
...
int Ball::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: calcAcceleration((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        case 2: calcPosition(); break;
        case 3: calcVelocity(); break;
        case 4: draw(); break;
        case 5: updateCalculations(); break;
        case 6: collisionFrom((*reinterpret_cast< QVector3D(*)>(_a[1]))); break;
        case 7: endCollision(); break;
        default: ;
        }
        _id -= 8;
    }
